...
public class WebUtils {
    ...
    public void touchCoordinate(WebElement webElement) {
        int x = webElement.getRect().x + webElement.getRect().width / 2;
        int y = webElement.getRect().y + webElement.getRect().height / 2;
